...
echo "rival"
Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one0", "subs") -SearchString "getViewStateUpdater"
# Find-Str -Path $path3a -ExcludeDirs @("third", "src", "data", "neo-subs") -SearchString "__print_pass_sequence__"
