...
echo "rival"
# Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one0", "subs") -SearchString "f_42111_asSceneObject_z_a"
...
Find-Str -Path $path12 -ExcludeDirs @("node_modules", "dist", "pdf", "libs", "ceph") -SearchString "getToothStepMatrix"
