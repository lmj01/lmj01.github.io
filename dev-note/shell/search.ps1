...
echo "rival"
Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one0", "subs") -SearchString "ZoomSubscriptionCreator"
# Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one1", "subs") -SearchString "mousemove"
# Find-Str -Path $path3a -ExcludeDirs @("third", "src", "data", "neo-subs") -SearchString "CameraRotationEvent"
