...
echo "rival"
# Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one0") -SearchString "rxjs"
...
echo "3d-render"
Find-Str -Path $path11 -ExcludeDirs @("node_modules", "dist", "doc") -SearchString "useTweakpaneUi"
