...
echo "rival"
Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one0") -SearchString "m83941U8"
# Find-Str -Path $path3a -ExcludeDirs @("third", "src", "data") -SearchString "RebuildGingivaComponent"

$path4 = "F:\platform\sfebackend"
echo "sfebackend"
# Find-Str -Path $path4 -ExcludeDirs @("node_modules", "dist") -SearchString "newDevice"
