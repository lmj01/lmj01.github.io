...
echo "rival"
Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one0", "subs") -SearchString "t25016Pipeline"
...
echo "cornerstone3D"
# Find-Str -Path $path7 -ExcludeDirs @("node_modules", "dist", ".webpack", ".vscode", ".github", ".git", ".circleci", ".static-examples") -SearchString "CustomEvent"
...
$path12 = "F:\java\matchyun-orthodontic\src\main\webapp\"
echo "solution-Enterprise"
# Find-Str -Path $path12 -ExcludeDirs @("node_modules", "dist", "pdf", "libs", "ceph", "img", "resource", "lib", "system") -SearchString "class"
...
$path15a = "F:\study\three.js\src"
echo "three.js"
# Find-Str -Path $path15 -ExcludeDirs @("node_modules", "build") -SearchString "mergeGeometries"
# Find-Str -Path $path15a -ExcludeDirs @("node_modules", "build", "examples") -SearchString "opacity"
