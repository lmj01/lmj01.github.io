...
echo "rival"
Find-Str -Path $path3 -ExcludeDirs @("third", "node_modules", "data", "one0", "subs") -SearchString "nodeMaterial"
Find-Str -Path $path3a -ExcludeDirs @("third", "src", "data", "neo-subs") -SearchString "nodeMaterial"
...
echo "cornerstone3D"
# Find-Str -Path $path7 -ExcludeDirs @("node_modules", "dist", ".webpack", ".vscode", ".github", ".git", ".circleci", ".static-examples") -SearchString "getDefaultImageData"
